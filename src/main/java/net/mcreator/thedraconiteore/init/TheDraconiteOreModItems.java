...
public class TheDraconiteOreModItems {
	public static final DeferredRegister<Item> REGISTRY = DeferredRegister.create(ForgeRegistries.ITEMS, TheDraconiteOreMod.MODID);
	...
	public static final RegistryObject<Item> DRACONITE_ORE = block(TheDraconiteOreModBlocks.DRACONITE_ORE, TheDraconiteOreModTabs.TAB_DRAC_CREAT_TAB);
	public static final RegistryObject<Item> RAW_DRACONITE = REGISTRY.register("raw_draconite", () -> new RawDraconiteItem());
	public static final RegistryObject<Item> DRACONITE_BLOCK = block(TheDraconiteOreModBlocks.DRACONITE_BLOCK, TheDraconiteOreModTabs.TAB_DRAC_CREAT_TAB);
